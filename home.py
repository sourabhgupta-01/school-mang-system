...
def web_desiner():
    ...
    # image
    image1=Image.open("C:\\Users\\ASUS\\onedrive\\desktop\\school1\\priyanka.jpg")
    photo1=ImageTk.PhotoImage(image1)
    l1=tkinter.Button(f3,image=photo1)
    l1.place(x=1150,y=10)
    name=tkinter.Label(f3,text="Priyanka Kumari",fg="black",bg="white",font="arial 16 bold")
    name.place(x=1150,y=250)
    edu=tkinter.Label(f3,text="Bachelor of Science(Computer Application)",fg="black",bg="white",font="arial 12 bold")
    edu.place(x=1150,y=280)
